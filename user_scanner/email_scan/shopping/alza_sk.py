...
async def validate_alza_sk(email: str) -> Result:
    """
    Checks whether an email is associated with an account or order on alza.sk website.
    """
