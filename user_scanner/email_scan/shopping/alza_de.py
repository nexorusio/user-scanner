...
async def validate_alza_de(email: str) -> Result:
    """
    Checks whether an email is associated with an account or order on alza.de website.
    """
