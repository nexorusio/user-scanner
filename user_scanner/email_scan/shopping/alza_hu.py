...
async def validate_alza_hu(email: str) -> Result:
    """
    Checks whether an email is associated with an account or order on alza.hu website.
    """
