...
def validate_dubstepforum_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://www.dubstepforum.com/forum/memberlist.php?mode=viewprofile&un={encoded_user}"
    show_url = f"https://www.dubstepforum.com/forum/memberlist.php?mode=viewprofile&un={encoded_user}"
