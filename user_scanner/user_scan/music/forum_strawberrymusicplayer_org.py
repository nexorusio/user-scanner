...
def validate_forum_strawberrymusicplayer_org(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://forum.strawberrymusicplayer.org/user/{encoded_user}"
    show_url = f"https://forum.strawberrymusicplayer.org/user/{encoded_user}"
