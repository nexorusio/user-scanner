...
def validate_lemmy_criticalbasics_xyz(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.criticalbasics.xyz/api/v3/user"
    show_url = f"https://lemmy.criticalbasics.xyz/u/{encoded_user}"
