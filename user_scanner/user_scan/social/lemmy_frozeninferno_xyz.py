...
def validate_lemmy_frozeninferno_xyz(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.frozeninferno.xyz/api/v3/user"
    show_url = f"https://lemmy.frozeninferno.xyz/u/{encoded_user}"
