...
def validate_discover_deltanauten_de(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://discover.deltanauten.de/api/v3/user"
    show_url = f"https://discover.deltanauten.de/u/{encoded_user}"
