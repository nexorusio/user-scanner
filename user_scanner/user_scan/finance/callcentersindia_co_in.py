...
def validate_callcentersindia_co_in(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://www.callcentersindia.co.in/user/{encoded_user}"
    show_url = f"https://www.callcentersindia.co.in/user/{encoded_user}"
