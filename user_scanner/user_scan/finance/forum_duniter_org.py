...
def validate_forum_duniter_org(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://forum.duniter.org/u/{encoded_user}.json"
    show_url = f"https://forum.duniter.org/u/{encoded_user}"
                ...
                if user_obj and isinstance(user_obj, dict) and user_obj.get("username"):
                    ...
                    if avatar_template:
                        ...
                        if avatar_url.startswith("/"):
                            avatar_url = f"https://forum.duniter.org{avatar_url}"
