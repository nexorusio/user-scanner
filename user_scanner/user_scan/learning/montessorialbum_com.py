...
def validate_montessorialbum_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://montessorialbum.com/montessori/index.php/User:{encoded_user}"
    show_url = f"https://montessorialbum.com/montessori/index.php/User:{encoded_user}"
