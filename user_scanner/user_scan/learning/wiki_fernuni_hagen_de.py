...
def validate_wiki_fernuni_hagen_de(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://wiki.fernuni-hagen.de/helpdesk/User:{encoded_user}"
    show_url = f"https://wiki.fernuni-hagen.de/helpdesk/User:{encoded_user}"
