...
def validate_thinktank_brainstormes_org(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://thinktank.brainstormes.org/api/v3/user"
    show_url = f"https://thinktank.brainstormes.org/u/{encoded_user}"
