...
def validate_books_superawesomecorp_space(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://books.superawesomecorp.space/user/{encoded_user}"
    show_url = f"https://books.superawesomecorp.space/user/{encoded_user}"
