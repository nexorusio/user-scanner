...
def validate_audio_drama_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"http://audio-drama.com/doku.php/directory/u/{encoded_user}"
    show_url = f"http://audio-drama.com/doku.php/directory/u/{encoded_user}"
