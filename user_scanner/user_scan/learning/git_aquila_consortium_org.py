...
def validate_git_aquila_consortium_org(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://git.aquila-consortium.org/{encoded_user}"
    show_url = f"https://git.aquila-consortium.org/{encoded_user}"
