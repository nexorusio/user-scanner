...
def validate_alsa_project_org(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://alsa-project.org/wiki/User:{encoded_user}"
    show_url = f"https://alsa-project.org/wiki/User:{encoded_user}"
