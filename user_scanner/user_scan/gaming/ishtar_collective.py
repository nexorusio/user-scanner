...
def validate_ishtar_collective(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://commons.ishtar-collective.net/u/{encoded_user}.json"
    show_url = f"https://commons.ishtar-collective.net/u/{encoded_user}"
                ...
                if user_obj and isinstance(user_obj, dict) and user_obj.get("username"):
                    ...
                    if avatar_template:
                        ...
                        if avatar_url.startswith("/"):
                            avatar_url = f"https://commons.ishtar-collective.net{avatar_url}"
