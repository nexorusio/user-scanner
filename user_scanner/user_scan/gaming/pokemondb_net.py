...
def validate_pokemondb_net(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://pokemondb.net/pokebase/user/{encoded_user}"
    show_url = f"https://pokemondb.net/pokebase/user/{encoded_user}"
