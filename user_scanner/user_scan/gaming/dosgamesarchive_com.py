...
def validate_dosgamesarchive_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://www.dosgamesarchive.com/profile/{encoded_user}"
    show_url = f"https://www.dosgamesarchive.com/profile/{encoded_user}"
