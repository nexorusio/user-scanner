...
def validate_online_ts2009_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://online.ts2009.com/mediaWiki/User:{encoded_user}"
    show_url = f"https://online.ts2009.com/mediaWiki/User:{encoded_user}"
