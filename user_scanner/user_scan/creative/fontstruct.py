...
def validate_fontstruct(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://fontstruct.com/fontstructors/{encoded_user}"
    show_url = f"https://fontstruct.com/fontstructors/{encoded_user}"
