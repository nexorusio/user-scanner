...
def validate_forum_bricsys_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://forum.bricsys.com/profile/{encoded_user}"
    show_url = f"https://forum.bricsys.com/profile/{encoded_user}"
