...
def validate_myfonts_user(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://www.myfonts.com/collections/{encoded_user}"
    show_url = f"https://www.myfonts.com/collections/{encoded_user}"
