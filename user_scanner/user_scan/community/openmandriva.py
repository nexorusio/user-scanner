...
def validate_openmandriva(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://forum.openmandriva.org/u/{encoded_user}.json"
    show_url = f"https://forum.openmandriva.org/u/{encoded_user}"
                ...
                if user_obj and isinstance(user_obj, dict) and user_obj.get("username"):
                    ...
                    if avatar_template:
                        ...
                        if avatar_url.startswith("/"):
                            avatar_url = f"https://forum.openmandriva.org{avatar_url}"
