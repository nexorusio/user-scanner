...
def validate_git_privatepractice_app(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://git.privatepractice.app/api/v1/users/{encoded_user}"
    show_url = f"https://git.privatepractice.app/{encoded_user}"
    headers = {
