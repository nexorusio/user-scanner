...
def validate_git_softkittypa_ws(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://git.softkittypa.ws/api/v1/users/{encoded_user}"
    show_url = f"https://git.softkittypa.ws/{encoded_user}"
    headers = {
