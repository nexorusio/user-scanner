...
def validate_git_lehtodigital_fi(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://git.lehtodigital.fi/api/v1/users/{encoded_user}"
    show_url = f"https://git.lehtodigital.fi/{encoded_user}"
    headers = {
