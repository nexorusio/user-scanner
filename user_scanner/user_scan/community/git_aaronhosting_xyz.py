...
def validate_git_aaronhosting_xyz(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://git.aaronhosting.xyz/api/v1/users/{encoded_user}"
    show_url = f"https://git.aaronhosting.xyz/{encoded_user}"
    headers = {
