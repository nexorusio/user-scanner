...
def validate_escj(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://community.escj.net/u/{encoded_user}.json"
    show_url = f"https://community.escj.net/u/{encoded_user}"
                ...
                if user_obj and isinstance(user_obj, dict) and user_obj.get("username"):
                    ...
                    if avatar_template:
                        ...
                        if avatar_url.startswith("/"):
                            avatar_url = f"https://community.escj.net{avatar_url}"
