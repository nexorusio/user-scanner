...
def validate_community_darkscribes_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://community.darkscribes.com/user/{encoded_user}"
    show_url = f"https://community.darkscribes.com/user/{encoded_user}"
