...
def validate_racket(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://racket.discourse.group/u/{encoded_user}.json"
    show_url = f"https://racket.discourse.group/u/{encoded_user}"
                ...
                if user_obj and isinstance(user_obj, dict) and user_obj.get("username"):
                    ...
                    if avatar_template:
                        ...
                        if avatar_url.startswith("/"):
                            avatar_url = f"https://racket.discourse.group{avatar_url}"
