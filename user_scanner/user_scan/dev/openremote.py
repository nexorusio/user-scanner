...
def validate_openremote(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://forum.openremote.io/u/{encoded_user}.json"
    show_url = f"https://forum.openremote.io/u/{encoded_user}"
                ...
                if user_obj and isinstance(user_obj, dict) and user_obj.get("username"):
                    ...
                    if avatar_template:
                        ...
                        if avatar_url.startswith("/"):
                            avatar_url = f"https://forum.openremote.io{avatar_url}"
