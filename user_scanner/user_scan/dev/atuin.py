...
def validate_atuin(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://forum.atuin.sh/u/{encoded_user}.json"
    show_url = f"https://forum.atuin.sh/u/{encoded_user}"
    headers = {
                ...
                if user_obj and isinstance(user_obj, dict) and user_obj.get("username"):
                    ...
                    if avatar_template:
                        ...
                        if avatar_url.startswith("/"):
                            avatar_url = f"https://forum.atuin.sh{avatar_url}"
