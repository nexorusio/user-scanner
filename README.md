...
<p align="center">
  <img src="https://img.shields.io/badge/Version-1.5.1.2-blueviolet?style=for-the-badge&logo=github" />
...
With **550+ total scan vectors**—including **175+ email-integrated sites** and **375+ username platforms**—you can map digital footprints, analyze target behavior, uncover interests, full metadata of usernames and verify account registrations in seconds.
...
- 🔎 **Deep Email & Username OSINT:** Look up email registrations and perform advanced username profiling across 550+ platforms.
...
Web platforms constantly update authentication flows. Maintaining over 550+ scan modules requires around-the-clock commitment to keep the suite reliable and free for the cybersecurity community.
